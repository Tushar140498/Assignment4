...
class App:
    ...
    def start(self):
        ...
        print(f"Usage: Command num1 num2 (Ex: add 3 4) or type menu for list of all commands or type 'exit' to exit.\n")
        ...
        while True:  # REPL (Read, Evaluate, Print, Loop)
            ...
            if command_name == 'menu':  # Handle 'menu' command directly
                MenuCommand().execute()  # Execute menu command without registering it
                continue  # Go back to REPL prompt
